# RailsAdmin config file. Generated on January 07, 2013 13:35
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Storage Ui', 'Admin']
  ...
  # config.excluded_models = ['AdminUser', 'Unit', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['AdminUser', 'Unit', 'User']
